...
import PaidAccountListTableRow from './tableRow';

const PaidAccountListTable = () => {
        ...
        <Table>
          ...
          <TableBody>
            {accounts.map((account, index) => (
              <PaidAccountListTableRow key={account.id} index={index} />
            ))}
          </TableBody>
        </Table>
      </TableContainer>
...
export default PaidAccountListTable;